              ...
              <div className="p-8 overflow-y-auto flex-1 space-y-8">
                 <div className="space-y-2">
                   <label className="text-sm font-bold text-slate-700 flex justify-between">
                     Korporativ Rol Nomi
                     {["ADMIN", "DEKAN", "MUDIR", "PROFESSOR", "DOTSENT", "KATTA_OQITUVCHI", "ASSISTENT"].includes(roleForm.name) && (
                   ...
                   <input 
                     required 
                     disabled={["ADMIN", "DEKAN", "MUDIR", "PROFESSOR", "DOTSENT", "KATTA_OQITUVCHI", "ASSISTENT"].includes(roleForm.name)}
                     value={roleForm.name} 
